...
import { getDashboardMetrics, exportSalesReport, getTopProducts, getSalesChart, getLowStockAlerts, getCashFlow, getRegistersConsolidated } from './reports.controller.js';
